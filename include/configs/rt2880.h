...
#define CONFIG_ETHADDR      "20:23:06:26:20:29"
...
#define RT2880_REG_PIOINT1       (RT2880_PRGIO_ADDR + 0x94)
#define RT2880_REG_PIOINT2       (RT2880_PRGIO_ADDR + 0x98)

#define RT2880_REG_PIOEDGE      (RT2880_PRGIO_ADDR + 0xA0)
#define RT2880_REG_PIOEDGE1      (RT2880_PRGIO_ADDR + 0xA4)
#define RT2880_REG_PIOEDGE2      (RT2880_PRGIO_ADDR + 0xA8)

#define RT2880_REG_PIORENA      (RT2880_PRGIO_ADDR + 0x50)
#define RT2880_REG_PIORENA1      (RT2880_PRGIO_ADDR + 0x54)
#define RT2880_REG_PIORENA2      (RT2880_PRGIO_ADDR + 0x58)

#define RT2880_REG_PIOFENA      (RT2880_PRGIO_ADDR + 0x60)
#define RT2880_REG_PIOFENA1      (RT2880_PRGIO_ADDR + 0x64)
#define RT2880_REG_PIOFENA2      (RT2880_PRGIO_ADDR + 0x68)

#define RT2880_REG_PIODATA      (RT2880_PRGIO_ADDR + 0x20)
#define RT2880_REG_PIODATA1      (RT2880_PRGIO_ADDR + 0x24)
#define RT2880_REG_PIODATA2      (RT2880_PRGIO_ADDR + 0x28)

#define RT2880_REG_PIODIR       (RT2880_PRGIO_ADDR + 0x00)
#define RT2880_REG_PIODIR1       (RT2880_PRGIO_ADDR + 0x04)
#define RT2880_REG_PIODIR2       (RT2880_PRGIO_ADDR + 0x08)

#define RT2880_REG_PIOSET       (RT2880_PRGIO_ADDR + 0x30)
#define RT2880_REG_PIOSET1       (RT2880_PRGIO_ADDR + 0x34)
#define RT2880_REG_PIOSET2       (RT2880_PRGIO_ADDR + 0x38)

#define RT2880_REG_PIORESET     (RT2880_PRGIO_ADDR + 0x40)
#define RT2880_REG_PIORESET1     (RT2880_PRGIO_ADDR + 0x44)
#define RT2880_REG_PIORESET2     (RT2880_PRGIO_ADDR + 0x48)

#else
#define RT2880_REG_PIOINT       (RT2880_PRGIO_ADDR + 0)
#define RT2880_REG_PIOINT1	(RT2880_PRGIO_ADDR + 0x38)
#define RT2880_REG_PIOINT2	(RT2880_PRGIO_ADDR + 0x60)
#define RT2880_REG_PIOINT3	(RT2880_PRGIO_ADDR + 0x88)

#define RT2880_REG_PIOEDGE      (RT2880_PRGIO_ADDR + 0x04)
#define RT2880_REG_PIOEDGE1	(RT2880_PRGIO_ADDR + 0x3C)
#define RT2880_REG_PIOEDGE2	(RT2880_PRGIO_ADDR + 0x64)
#define RT2880_REG_PIOEDGE3	(RT2880_PRGIO_ADDR + 0x8C)

#define RT2880_REG_PIORENA	(RT2880_PRGIO_ADDR + 0x08)
#define RT2880_REG_PIORENA1	(RT2880_PRGIO_ADDR + 0x40)
#define RT2880_REG_PIORENA2	(RT2880_PRGIO_ADDR + 0x68)
#define RT2880_REG_PIORENA3	(RT2880_PRGIO_ADDR + 0x90)

#define RT2880_REG_PIOFENA      (RT2880_PRGIO_ADDR + 0x0C)
#define RT2880_REG_PIOFENA1     (RT2880_PRGIO_ADDR + 0x44)
#define RT2880_REG_PIOFENA2     (RT2880_PRGIO_ADDR + 0x6C)
#define RT2880_REG_PIOFENA3     (RT2880_PRGIO_ADDR + 0x94)

#define RT2880_REG_PIODATA      (RT2880_PRGIO_ADDR + 0x20)
#define RT2880_REG_PIODATA1     (RT2880_PRGIO_ADDR + 0x48)
#define RT2880_REG_PIODATA2     (RT2880_PRGIO_ADDR + 0x70)
#define RT2880_REG_PIODATA3     (RT2880_PRGIO_ADDR + 0x98)

#define RT2880_REG_PIODIR       (RT2880_PRGIO_ADDR + 0x24)
#define RT2880_REG_PIODIR1      (RT2880_PRGIO_ADDR + 0x4C)
#define RT2880_REG_PIODIR2      (RT2880_PRGIO_ADDR + 0x74)
#define RT2880_REG_PIODIR3      (RT2880_PRGIO_ADDR + 0x9C)

#define RT2880_REG_PIOSET       (RT2880_PRGIO_ADDR + 0x2C)
#define RT2880_REG_PIOSET1      (RT2880_PRGIO_ADDR + 0x54)
#define RT2880_REG_PIOSET2      (RT2880_PRGIO_ADDR + 0x7C)
#define RT2880_REG_PIOSET3      (RT2880_PRGIO_ADDR + 0xA4)

#define RT2880_REG_PIORESET     (RT2880_PRGIO_ADDR + 0x30)
#define RT2880_REG_PIORESET1    (RT2880_PRGIO_ADDR + 0x58)
#define RT2880_REG_PIORESET2    (RT2880_PRGIO_ADDR + 0x80)
#define RT2880_REG_PIORESET3    (RT2880_PRGIO_ADDR + 0xA8)
#endif
...
#define WEBFAILSAFE_UPLOAD_UBOOT_SIZE_IN_BYTES		( 190 * 1024 )
#define UPDATE_SCRIPT_UBOOT_SIZE_IN_BYTES		"0x20000"
#define WEBFAILSAFE_UPLOAD_BACKUP_SIZE_IN_BYTES         ( 2560 * 1024) //2.5M
...
#define WEBFAILSAFE_UPGRADE_TYPE_BACKUP			3
